...
public class DatabaseConfig {
    ...
    public static boolean useFileDb() {
        // System property override first
        String systemFlag = System.getProperty("use.file.db");
        if (systemFlag != null && !systemFlag.isEmpty()) {
            return Boolean.parseBoolean(systemFlag);
        }
        String prop = properties.getProperty("use.file.db");
